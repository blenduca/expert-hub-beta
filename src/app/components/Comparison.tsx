  ...
  return (
    <section className="relative py-24 overflow-hidden bg-black" style={{ background: '#050505' }}>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(194,34,53,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(194,34,53,0.05) 1px, transparent 1px)',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <AnimatedSection className="text-center mb-6" direction="up">
          ...
          >
            ...
            <span style={{ color: '#C22235' }}>IA</span> irão perder relevância.
          </h2>
        </AnimatedSection>

        <AnimatedSection className="text-center mb-16 max-w-3xl mx-auto" direction="up" delay={100}>
          <p className="text-gray-500 text-balance" style={{ fontSize: '1rem', lineHeight: 1.8 }}>
            ...
            O <span className="text-[#e05969]">Expert Hub</span> é o caminho para liderar essa transição, não ser engolido por ela.
          </p>
        </AnimatedSection>
          ...
          <AnimatedSection direction="left" delay={100}>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  <div className="text-gray-500 tracking-widest" style={{ fontSize: '0.6rem', fontWeight: 700 }}>
                    Antes
                  </div>
          ...
          <AnimatedSection direction="right" delay={200}>
            <div
              ...
              style={{
                ...
                boxShadow: '0 0 50px rgba(194,34,53,0.08)',
              }}
            >
              {/* Top glow */}
              <div
              ...
              <div className="flex items-center gap-3 mb-8">
                <div
                  className="w-10 h-10 rounded-xl flex items-center justify-center"
                  style={{ background: 'rgba(194,34,53,0.15)', border: '1px solid rgba(194,34,53,0.3)' }}
                >
                  <Check size={18} color="#C22235" />
                </div>
                <div>
                  <div className="text-[#C22235] tracking-widest" style={{ fontSize: '0.6rem', fontWeight: 700 }}>
                    Agora
                  </div>
                  <div className="text-white" style={{ fontSize: '1.1rem', fontWeight: 700 }}>
                    Modelo expert
              ...
              <div className="flex flex-col gap-4">
                {expertHub.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 p-4 rounded-xl"
                    style={{ background: 'rgba(194,34,53,0.05)', border: '1px solid rgba(194,34,53,0.12)' }}
                  >
                    <div
                      className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                      style={{ background: 'rgba(194,34,53,0.2)', border: '1px solid rgba(194,34,53,0.4)' }}
                    >
                      <Check size={10} color="#C22235" />
                    </div>
